...
const banmsgtype = '*Vacilo aqui é só um, tchau otaro🙄🤙*'
...
const banmsglink = 'Vacilo aqui é só um, tchau otaro🙄🤙...'
...
const botputa = 'Sua senhora mãe 😡'
const botgay = 'Falou o baba ovo 😡'
const botviado = 'Falou o baba ovo 😡'
const numbotfeio = 'sua senhora mãe 😡'
// KEYS
...
let mess = {
    wait: '⌛ ESPERE, QUE TAL UM SUQUINHO POR ENQUANTO QUE EU FAÇO OQ VC TÁ QUERENDO🧃🐧',
    success: 'YES BABY!! AQUI OQ VOCÊ QUERIA🧃🐧',
    error: {
